...
import { Eye, Code, Palette, Type, Layout } from 'lucide-react';
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('bodyBg', e.target.value)}
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="content-bg">Content Background</Label>
                  <Input
                    id="content-bg"
                    value={settings.contentBg}
                    onChange={(e) => handleSettingChange('contentBg', e.target.value)}
                  />
                </div>
